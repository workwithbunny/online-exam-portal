...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>JSSATE Bangalore</b></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       ...
       <li  <?php if(@$_GET['q']==1) echo'class="active"'; ?>class="nav-item"><a href="trigger.php" class="nav-link active">My Contact</a> </li>
...
<a href="https://jssateb.ac.in/" target="_blank">JSSATE Bangalore</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<h4 style="font-family:'typo' ">anjanakaudinya@gmail.com</h4>
