...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2023 at 07:33 PM
...
('63c5294d540f3', 'Aniket Dey', 'aniketdey1505@gmail.com', 'feedback', 'amazing', '2023-01-16', '11:39:09am');
...
('aniketdey1505@gmail.com', '5589741f9ed52', -5, 5, 0, 5, '2023-01-16 06:33:42');
...
INSERT INTO `logs` (`email`, `mob`) VALUES
('aniketdey1503@gmail.com', '7973818307'),
('aniketdey1503@gmail.com', '0'),
('aniketdey1503@gmail.com', '0'),
('aniketdey1503@gmail.com', '0'),
('aniketdey1503@gmail.com', '0'),
('aniketdey1503@gmail.com', '0'),
('aniketdey1503@gmail.com', ''),
('aniketdey1503@gmail.com', '9988774422'),
('aniketdey1503@gmail.com', '8329128422');
...
('Aniket Dey', 'M', 'JSSATEB', 'aniketdey1503@gmail.com', '8329128422', 'e10adc3949ba59abbe56e057f20f883e'),
('Aniket Dey', 'M', 'JSSATEB', 'aniketdey1505@gmail.com', '7973818304', '827ccb0eea8a706c4c34a16891f84e7b'),
...
--
DELIMITER $$
CREATE TRIGGER `logs` AFTER UPDATE ON `user` FOR EACH ROW INSERT INTO logs VALUES(OLD.email,NEW.mob)
$$
DELIMITER ;
...
--
ALTER TABLE `questions`
  ADD CONSTRAINT `FOREIGN KEY` FOREIGN KEY (`eid`) REFERENCES `quiz` (`eid`) ON DELETE CASCADE;
COMMIT;
